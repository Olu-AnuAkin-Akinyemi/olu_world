...
- Single-resolution images generated by `scripts/optimize-images.mjs`
- **Known issue:** Sharp overwrites originals in-place (destructive) — running the script twice causes generation loss. Phase 1 resolves this by generating variants alongside untouched originals.
- One format (WebP for gallery/logos, PNG for nav logos)
- No responsive `srcset`, no AVIF, no blur-up placeholders
- Gallery images at 600px, modeling photos at 600px (too small for overlay)
